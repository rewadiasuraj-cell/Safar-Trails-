...
const DESTINATION_TITLE_OVERRIDES: Record<string, string> = {
  ...
  // Was "Himachal Tour Packages – Manali & Shimla". Manali and Shimla now have
  // their own destination pages, and this one naming both put three pages on
  // the site in front of the same queries. This keeps the state-level phrase
  // and leaves the city ones to the city pages.
  'himachal-pradesh': 'Himachal Tour Packages – Plan Your Trip | Safar Trails',
  ...
  // Same split as Shimla: /tour-packages/himachal-manali-solang-sissu-retreat
  // owns "Manali Tour Package", so this page takes the research queries.
